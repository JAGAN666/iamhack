-- Supabase Database Schema for Academic NFT Marketplace
...
-- Insert demo user data (you'll need to get the actual UUID from Supabase Auth)
-- This will be inserted after we create the demo user in Supabase Auth
